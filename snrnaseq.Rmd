...
```{r}
nonzero_cells <- Matrix::colSums(expr_matrix > 0) >= 200
filtered_matrix <- expr_matrix[, nonzero_cells]
nonzero_genes <- Matrix::rowSums(expr_matrix > 0) >= 10  # expresso em pelo menos 10 células
expr_matrix_filtered <- expr_matrix[nonzero_genes, ]
