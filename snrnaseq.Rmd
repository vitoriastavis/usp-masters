...
combine_varPart_results <- function(gse_path, top_percentage) {
  ...
  files <- list.files(variance_dir, pattern = "\\.RData$", full.names = TRUE)
...
top_genes_GSE213982 <- combine_varPart_results(gse_path, top_percentage = 0.95)
...
top_genes_GSE144136 <- combine_varPart_results("data/snrnaseq/GSE144136/", top_percentage = 0.95)
...
intersection <- intersect(common_degs, targets_intersection)
