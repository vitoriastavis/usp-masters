...
targets_to_metabolites$RARB <- unique(targets_to_metabolites$RARB)
targets_to_metabolites$EP300 <- unique(targets_to_metabolites$EP300)
targets_to_metabolites$PDE4B <- unique(targets_to_metabolites$PDE4B)
