...
```{r}
gse_path <- "data/snrnaseq/GSE144136/"
degs_GSE144136 <- read.csv(paste0(gse_path, "degs/GSE144136_results_filtered.csv"))$X

gse_path <- "data/snrnaseq/GSE213982/"
degs_GSE213982 <- read.csv(paste0(gse_path, "degs/GSE213982_results_filtered.csv"))$X
...
traitData <- GSE213982@meta.data[, c("condition", "cell_type")]

GSE213982_matrix <- GetAssayData(GSE213982, assay = "RNA", slot = "data")
...
twas_targets <- notype_intersection
