...
stp_chembl_degs <- intersect(stp_chembl, snrnaseq_intersection)
sea_chembl_degs <- intersect(sea_chembl, snrnaseq_intersection)
...
# Agora intersection_results tem cada combinação como chave e o resultado como vetor
```
...
save(metabolites_to_targets_fgfr3, metabolites_to_targets_fgfr3, file="data/targets_metabolites_fgfr3.RData")
```
