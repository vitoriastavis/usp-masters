...
degs_GSE213982_expr <- read.csv("degs_sct_novo/GSE213982_2_99_2000_results_adj.csv")
...
csv_folder <- "../usp-masters/data/target_prediction/intersections"
...
save(intersection_results, file="degs_sct/intersect_08.RData")
