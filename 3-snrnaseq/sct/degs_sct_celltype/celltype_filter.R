...
snrnaseq_intersection_celltype <- unique(unname(unlist(intersection_celltypes)))

# combine bulk and cell type
all_degs_intersected <- union(snrnaseq_intersection_celltype, snrnaseq_intersection)
