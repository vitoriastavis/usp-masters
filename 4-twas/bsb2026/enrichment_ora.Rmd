...
```{r message=FALSE, warning=FALSE}
remove_terms <- c()
# remove_terms <- c("Histone H2AXY142 kinase activity",
...
for (geneset in names(enrichments[1:2])){
  ...
  tryCatch({
      ...
      graph <- create_graph(e, remove_terms)
  
      save_files(graph, geneset, output_path, graph_h = 10, graph_w = 10)
