...
get_metabolites <- function(analysis_targets) {
  ...
  for (target in analysis_targets){
    ...
    original_queries <- stp_mappings[!is.na(stp_mappings$HGNC_ID) & stp_mappings$HGNC_ID == target, ]
    for (query in original_queries$Query) {
