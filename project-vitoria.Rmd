...
genus_to_keep <- names(genus_counts[genus_counts > 2])
...
microbe_distribution <- ggplot(gutmgene_filtered_count,
  ...
  theme_minimal() + 
  ggtitle("Distribution of Gut Microorganisms") +  
  theme(
    plot.title = element_text(size = 18, hjust = 0.5),  
    axis.title.y = element_text(size = 16),
    axis.title.x = element_text(size = 16),
    axis.text.y = element_text(size = 16),
    axis.text.x = element_text(size = 16, angle = 60, hjust = 1, face = "italic"),
...
directory <- "C:/Users/vitor/Documents/usp/usp-masters/data/stp"
